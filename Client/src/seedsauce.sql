...
('{"question":"IP addresses are?","incorrect":["Easier to read then URLs","A string made of letters and numbers","Network addresses that are easy to read"],"correct":"Unique addresses that identify devices on the internet or a local network"}' ),            
...
('{"question":"What is the DOM":["The DOM is an object-oriented representation a squid","The DOM is a programming language","A visualization of code"],"correct":"The DOM represents the document as nodes and objects"}' ),            
('{"question":"What is diffing?":["Subtracting one number from another","Looking at the difference between two or more strings","When React compares the DOM with the virtual DOM"],"correct":"When React compares the current version of the virtual DOM with the previous version of the virtual DOM"}' ),            
('{"question":"1,000 Mbps is equal to what?":["1 kilobit per second","1 megabyte per second","1 byte per second"],"correct":"1 gigabit per second"}' ),             
('{"question":"TIFF and JPEG file formats support image metadata called what?":["XSD","MIME","IMG"],"correct":"EXIF"}' ),             
('{"question":"In React useMemo() returns?":["A post it note","A squirrel","A function"],"correct":"A value"}' ),  
('{"question":"Vinton Cerf and Bob Kahn did what?":["Invented React","Invented Python","Invented Javascript"],"Invented the internet"}' ),  
('{"question":"A custom React Hook can?":["Update on a dependency array","Be used inside a normal function","Solve all your problems"],"correct":"Call other hooks"}' ),  
