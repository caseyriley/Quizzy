...
const AddModal = (props) => {
  ...
  function submit(e) {
    ...
    if (
      ...
      false1.current.value !== "" &&
      false2.current.value !== "" &&
      false3.current.value !== ""
    ) {
      const sub = {
      ...
      <div className={"add-modal-c"}>
        <div className={"add-modal-c-scroll"}>
          <div
            ...
            onClick={props.toggleAddModalState}
          >
            <div></div>
            <div></div>
          </div>
          ...
          <form className={"add-modal-form"}>
            <div
              id={"add-modal-instructions-c"}
              className={"add-modal-instructions-c"}
            >
              <p id={"add-modal-instructions"}>
                Use the form below to create a multiple choice coding question{" "}
            ...
            <label>
              ...
              <textarea
                ref={correct}
                placeholder={
                  "Enter the correct answer to the quizz question here"
                }
                minlength={1}
                maxlength={250}
              ></textarea>
            ...
            <label>
              ...
              <textarea
                ref={false1}
                placeholder={
                  "Enter an incorrect answer to the quizz question here"
                }
                minlength={1}
                maxlength={250}
              ></textarea>
