    ...
    <div className={"question"} id={`c${props.ky}`}>
      ...
      <label className={`question__answer checkbox-label`}>
        <input
          ...
          required
          onChange={check0}
          checked={checkState ? checkState[0] : false}
        />
        <span className="checkmark"></span>
        <span className="question__answer__text">
          {props.answers && props.answers[0]}
        </span>
      </label>
      ...
      <label className={`question__answer checkbox-label`}>
        <input
          ...
          required
          onChange={check1}
          checked={checkState ? checkState[1] : false}
        />
        <span className="checkmark"></span>
        <span className="question__answer__text">
          {props.answers && props.answers[1]}
        </span>
      </label>
      ...
      <label className={`question__answer checkbox-label`}>
        <input
          ...
          required
          onChange={check2}
          checked={checkState ? checkState[2] : false}
        />
        <span className="checkmark"></span>
        <span className="question__answer__text">
          {props.answers && props.answers[2]}
        </span>
      </label>
      ...
      <label className={`question__answer checkbox-label`}>
        <input
          ...
          required
          onChange={check3}
          checked={checkState ? checkState[3] : false}
        />
        <span className="checkmark"></span>
        <span className="question__answer__text">
          {props.answers && props.answers[3]}
        </span>
      </label>
    </div>
  );
